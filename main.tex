...
Latent behaviour analysis is the study of how the behaviour of a transition system changes when its state space is transformed. A transformation of the state space can model the effects of an attack, the effects of a fault, or arbitrary interactions of the system with an external force. 
\todo[inline]{Complete}
...
\dedicatory{To my family and friends. Your constant love and support made it possible.}
