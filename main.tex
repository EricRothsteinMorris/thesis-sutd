...
\usepackage{tikz}
\usepackage{tikz-cd}
\usetikzlibrary{arrows,automata, positioning, petri, shapes, snakes}
...
Submitted by\\[0.5cm]%[0.75cm]
\authorname % Author name - remove the \href bracket to remove the link

\vspace{2em}%{4em}

Thesis Advisor\\[0.5cm]%[0.75cm]
...
% I don't know who to thank, but I know I should thank everyone. It's the weirdest feeling in the world. Not to mention that maybe I should not specify what should I thank them for. 

%I cannot express my thanks enough to everyone who has helped me along the journey.
...
\todo[inline]{I will continue to write this once I am a bit less emotional.}
...
\dedicatory{To my family and friends, those who carry fragments my soul and those whose soul fragments I also carry.}
