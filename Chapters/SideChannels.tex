...
Until now, we have considered the effect of spatial transformations from an integrity perspective.Attacks modelled as spatial transformations alter the behaviour of systems, and we quantified how resilient a system is with respect to a set of attacks derived from a given attacker model. 
