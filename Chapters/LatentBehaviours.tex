...
Consider the functor $G=2\times \texttt{id}^2$ and a $G$-coalgebra $\mathbb{X}=(3,(\gamma,\delta))$ that can be used to recognise sequences of zeroes and ones that end in two consecutive ones when started at state 0., i.e. the language $(0+1(0+11^*0))^*111^*$. Figure~\ref{fig:ExampleLatent} shows the automaton corresponding to the $G$-coalgebra $\mathbb{X}$ if $\gamma$ and $\delta$ are defined as follows
\begin{align}
\gamma(x)=\begin{cases}
1, \quad \text{if  $x=1$,}\\
...
\protect\begin{align*}
	\TheLatentBehaviourOf{0}{m}&=(0+1(0+11^*0))^*111^*, \\
	\TheLatentBehaviourOf{1}{m}&=0\TheLatentBehaviourOf{0}{m}+1\TheLatentBehaviourOf{2}{m}\\ 
	\TheLatentBehaviourOf{2}{m}&=1^*+1^*0\TheLatentBehaviourOf{0}{m}
\protect\end{align*}
}
\end{figure}
...
\TheLatentBehaviourOf{1}{m}&=((0+1)0^*1)^*
\protect\end{align*}
}
...
\protect\begin{align*}
\TheLatentBehaviourOf{0}{m}&=(0+1(0+11^*0))^*1,\\
\TheLatentBehaviourOf{1}{m}&=\varepsilon+0\TheLatentBehaviourOf{0}{m}+1\TheLatentBehaviourOf{2}{m},\\
...
\TheLatentBehaviourOf{1}{m}&=\TheLatentBehaviourOf{2}{m}=1^*+1^*\TheLatentBehaviourOf{0}{m}
\protect\end{align*}
}
\end{figure}
...
\protect\begin{align*}
\TheLatentBehaviourOf{0}{m}&=\TheLatentBehaviourOf{1}{m}=(0+11^*0)^*11^* \text{(same as F3.13)},\\ 
\TheLatentBehaviourOf{2}{m}&=1^*+1^*0\TheLatentBehaviourOf{0}{m}
\protect\end{align*}
}
\end{figure}
...
\protect\begin{align*}
\TheLatentBehaviourOf{0}{m}&=(0+1(0+1(11)^*(0+10)))^*11(11)^* ,\\ 
...
\protect\begin{align*}
\TheLatentBehaviourOf{0}{m}&=(0+11^*0)^*11^*,  \text{ (same as F3.13)}\\ 
