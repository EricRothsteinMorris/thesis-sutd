...
In the following we show how to use bounded model checking to find spatial transformations which create a latent coalgebra that fails one or more security requirements. %whose coordinates are $V\cup G$, 
