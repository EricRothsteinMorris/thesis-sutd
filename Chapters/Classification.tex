...
{The benchmarks we selected have an average of 173 inputs, 8306 gates, 517 latches, and 80 requirements. } Under our formulation of attacker models, these benchmarks have on average $2^{8823}$ attacker models%, compared to 80 properties to be checked in model checking competitions
...
%-------------------------------------------------------------------------------------------------------------------------------------------------
\todo[inline]{We should conclude that we used SAT solvers to verify a system, and they can give us attacks, but that maybe we need not verify a system: we should test them instead, since we expect them to fail when in the presence of attackers. This takes us to the second application on CPSs}